...
from app.routes import bid as bid_routes          # noqa: E402
from app.routes import house_info as house_info_routes  # noqa: E402
...
app.include_router(house_info_routes.router)
